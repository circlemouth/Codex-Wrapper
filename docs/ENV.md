...
- `CODEX_EXPOSE_REASONING`: `0`/`1`. Controls whether the wrapper surfaces Codex "thinking" output. When `0`, the server filters reasoning blocks from the streamed text before returning responses. Default `1` keeps the raw reasoning visible.
