...
- CODEX_EXPOSE_REASONING: `true`/`false`. Default `true` to match prior behavior. Set to `false` to have the wrapper filter Codex “thinking” blocks from streamed responses.
